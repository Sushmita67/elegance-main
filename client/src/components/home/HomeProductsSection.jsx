    ...
    <section className="bg-light-grayish-blue py-12">
      <div className="lg:px-0 xl:px-3 lg:mx-20 xl:mx-28 2xl:mx-36 3xl:mx-auto max-w-3xl mx-auto lg:max-w-7xl lg:pb-16 lg:mt-7">
        ...
        <div className="mx-8 mt-28 sm:mt-20 lg:mt-14">
          <Link to="products">
          <button className="cart min-w-[4rem] w-full max-w-xs md:max-w-lg lg:max-w-none h-14 bg-pale-black border border-black rounded-lg mt-12 mx-auto text-black font-bold flex items-center justify-center lg:w-52 shadow-[inset_0_0_0_0_#fce5cd] hover:shadow-[inset_0_-4rem_0_0_#fce5cd] hover:text-black transition-all duration-300">
          Explore More
            </button>
          </Link>
        </div>
